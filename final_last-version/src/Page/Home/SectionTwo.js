  ...
  return (
    <div className='section-two-container'>
        <div className='section-two grid-system'>
            ...
            <p className='two-subheadline'>At our company, we are committed to serving and enriching the holistic wellness of older adults. We do that<br/>by providing them with a wearable device that monitors their health and safety, and connects them with<br/>their loved ones and caregivers. Our mission is to erase boundaries and empower older adults to live life to<br/>the fullest.</p>
