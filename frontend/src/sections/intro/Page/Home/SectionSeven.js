...
//               </div>
//               <Link to="/services" className="sec-seven-btn">
//                 <p>Learn More</p>
//               </Link>
//             </div>

//             <div className="seven-normal seven-card seven-card-two">
//               <div className="seven-card-content seven-card-header">
//                 Standard
//               </div>
//               <div className="seven-card-content seven-card-price">
...
//               </div>
//               <div className="seven-card-content seven-card-benefits">
//                 pay a moderate amount every month, and a moderate amount when
//                 you need help
//               </div>
//               <Link className="sec-seven-btn">
//                 <p>Learn More</p>
//               </Link>
//             </div>
