...
//         <p className="two-subheadlineNew">
//           At our company, we are committed to serving and enriching the holistic
//           wellness of older adults. We do that{" "}
//           {viewportWidth > 1030 ? <br /> : null}by providing them with a
//           wearable device that monitors their health and safety, and connects
//           them with {viewportWidth > 1030 ? <br /> : null}their loved ones and
//           caregivers. Our mission is to erase boundaries and empower older
//           adults to live life to {viewportWidth > 1030 ? <br /> : null}the
//           fullest.
//         </p>
//       </div>
...
//             <p className="card-subheadingNew">
//               We provide quality
//               <br />
...
//             <div className="mission-cardNew card3New">
//               <img
//                 className="card-imgNew card-img-threeNew"
//                 src={experience2}
//               />
//               <p className="card-headingNew">Experience</p>
//               <p className="card-subheadingNew">
