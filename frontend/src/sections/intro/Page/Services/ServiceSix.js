          ...
          <table>
            <thead>
              <tr className="ser-six-head">
                ...
                <td className="ser-six-headdata ser-six-columnThree">
                  Other healthcare
                  <br />
                  providers
                </td>
            ...
            <tbody>
              <tr className="ser-six-row">
                <td className="ser-six-body ser-six-bodytitle ser-six-columnOne">
                  Same/next-day appointments
                </td>
                <td className="ser-six-body ser-six-bodydata ser-six-columnTwo">
                  <FaRegCheckCircle size="1.3rem" className="ser-six-icon" />
                </td>
                <td className="ser-six-body ser-six-bodydata ser-six-columnThree">
                  Not likely
                </td>
              </tr>
              <tr className="ser-six-row">
                ...
                <td className="ser-six-body ser-six-bodydata ser-six-columnThree">
                  <FaRegCircle size="1.3rem" className="ser-six-icon" />
                </td>
              </tr>
              <tr className="ser-six-row">
                <td className="ser-six-body ser-six-bodytitle ser-six-columnOne">
                  Provide on-site care for patients
                </td>
                <td className="ser-six-body ser-six-bodydata ser-six-columnTwo">
                  <FaRegCheckCircle size="1.3rem" className="ser-six-icon" />
                </td>
              ...
              <tr className="ser-six-row">
                <td className="ser-six-body ser-six-bodytitle ser-six-columnOne">
                  treating patents with respect and care
                </td>
                <td className="ser-six-body ser-six-bodydata ser-six-columnTwo">
                  <FaRegCheckCircle size="1.3rem" className="ser-six-icon" />
                </td>
