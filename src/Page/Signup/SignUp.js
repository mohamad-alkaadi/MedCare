...
const SignUp = () => {
  ...
  const LoginStyles = {
    signInContainer: { height: SignInHeight, backgroundColor: "#ecfafe" },
  }
  const SmallLoginStyles = {
    signInContainer: { minHeight: SignInHeight, backgroundColor: "#ecfafe" },
  }
    ...
    <div>
      {!resetEmailSent ? (
        <div
          ...
          style={width > 565 ? hightStyles : SmallStyles}
        >
        ...
        <div
          className="sign-in-container email-sent-container"
          style={width > 565 ? hightStyles : SmallStyles}
        >
          <div className="sign-in email-sent-a signin-grid-system">
            ...
            <div className="email-sent-sloganTwo">
              We sent a password reset link to
            </div>
            <div className="email-sent-email">{resetEmailSave}</div>
            <div className="email-sent-notReceive">
